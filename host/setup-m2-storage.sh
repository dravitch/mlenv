...
log "Liste de tous les disques disponibles:"
lsblk
...
# Suggestion pour télécharger des ISO
log "Vous pouvez maintenant télécharger des ISO pour la création des VMs:"
log "wget -c -P $STORAGE_PATH/iso https://releases.ubuntu.com/22.04/ubuntu-22.04.4-live-server-amd64.iso"